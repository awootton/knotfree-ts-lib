...
export function BoxItItUp(message, nonce, theirPublicKey, ourSecretKey) {
    const mySecretKey = ourSecretKey;
    const rtmp = nacl.box(message, nonce, theirPublicKey, mySecretKey);
    const result = Buffer.from(rtmp);
    return result;
}
export function UnBoxIt(message, nonce, theirPublicKey, ourSecretKey) {
...
export function AddHeartbeatCallback(key, cb) {
...
export function getBase64FromPassphrase(phrase) {
...
export function toBase64Url(buf) {
    const result = b64.encode(buf);
    // const lll = result.length 32 to 43
    return result;
}
export function fromBase64Url(str) {
    const buf = b64.decode(str);
...
export function TokenPayloadToText(payload) {
...
export function TokenToLimitsText(token) {
    let str = '';
...
export function KnotFreeTokenStatsToText(payload) {
    let str = '';
