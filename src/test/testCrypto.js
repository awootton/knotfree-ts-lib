...
import * as util from '../includes/utils';
...
function test1() {
    ...
    var bytes = util.Sha256Hash(senderPass);
    ...
    var skeypair = getBoxKeyPairFromPassphrase(senderPass);
    ...
    var rkeypair = getBoxKeyPairFromPassphrase(receiverPass);
